      ...
      <Body>
        <>
          ...
          <p className="text-justify mt-5">
            ...
            băng tải,... cho tất cả các ngành công nghiệp như Ngành sản xuất
            giày, Ngành gỗ, Ngành điện tử, Ngành in ấn - in hoa, Ngành bao bì,
            Ngành thực phẩm, Ngành thuốc lá, Ngành đá Granit,{" "}
            <strong>Ngành tôn thép</strong>, Ngành hàng không, Ngành thể thao...
